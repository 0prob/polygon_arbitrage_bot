...
import type { DecodedWatcherLog, MutableWatcherState, WatcherPoolMeta, WatcherProtocolHandler, WatcherTopicMap } from "./watcher_types.ts";

type WatcherProtocolHandlerDeps = {
  topic0: WatcherTopicMap;
  updateV2State: (state: MutableWatcherState, decoded: DecodedWatcherLog, pool?: WatcherPoolMeta | null) => void;
  updateV3SwapState: (state: MutableWatcherState, decoded: DecodedWatcherLog, pool?: WatcherPoolMeta | null) => void;
  updateV3LiquidityState: (state: MutableWatcherState, decoded: DecodedWatcherLog, isMint: boolean, pool?: WatcherPoolMeta | null) => void;
};
