...
const V2_PROTOCOL_DEFS: Array<[string, string, string]> = [
  ["QuickSwap V2", "0x5757371414417b8C6CAad45bAeF941aBc7d3Ab32", "QUICKSWAP_V2"],
  ["SushiSwap V2", "0xc35dadb65012ec5796536bd9864ed8773abc74c4", "SUSHISWAP_V2"],
  ["Dfyn V2",       "0xE7Fb3e833eFE5F9c441105EB65Ef8b261266423B", "DFYN_V2"],
  ["ComethSwap V2", "0x800b052609c355cA8103E06F022aA30647eAd60a", "COMETHSWAP_V2"],
  ["ApeSwap V2",    "0xCf083Be4164828f00cAE704EC15a36D711491284", "APESWAP_V2"],
  ["Meshswap V2",   "0x9F3044f7F9FC8bC9eD615d54845b4577B833282d", "MESHSWAP_V2"],
  ["JetSwap V2",    "0x668ad0ed2622C62E24f0d5ab6B6Ac1b9D2cD4AC7", "JETSWAP_V2"],
  ["Uniswap V2",    "0x9e5A52f57b3038F1B8EeE45F28b3C1967e22799C", "UNISWAP_V2"],
];

// ─── Inline V3 pool-created protocols ─────────────────────────

const V3_PROTOCOL_DEFS: Array<[string, string, string]> = [
  ["Uniswap V3",    "0x1F98431c8aD98523631AE4a59f267346ea31F984", "UNISWAP_V3"],
  ["SushiSwap V3",  "0x917933899c6a5F8E37F31E19f92CdBFF7e8FF0e2", "SUSHISWAP_V3"],
];
...
function buildProtocols() {
  ...
  for (const [name, address, key] of V2_PROTOCOL_DEFS) {
    result[key] = createPairCreatedProtocol(name, address, {}, { startBlock: 0 });
  }

  for (const [name, address, key] of V3_PROTOCOL_DEFS) {
    result[key] = createUniV3PoolProtocol(name, address, {}, undefined, { startBlock: 0 });
  }
