    ...
    const goodEdges: SwapEdge[] = [
      {
        ...
        feeBps: 30n,
        stateRef: { reserve0: 10000n, reserve1: 20000n, token0: "0xa", token1: "0xb" },
      },
      {
        poolAddress: "0xp2" as Address,
        protocol: "UNISWAP_V2",
        tokenIn: "0xb" as Address,
        tokenOut: "0xa" as Address,
        feeBps: 30n,
        stateRef: { reserve0: 20000n, reserve1: 10000n, token0: "0xb", token1: "0xa" },
      },
    ];
