...
const ENV_TO_PATH: Record<string, [keyof AppConfig, string]> = {
  ...
  HYPERSYNC_RETRY_BASE_MS: ["hypersync", "retryBaseMs"],
  HYPERSYNC_RETRY_CEILING_MS: ["hypersync", "retryCeilingMs"],
  HYPERSYNC_RETRY_BACKOFF_MS: ["hypersync", "retryBackoffMs"],
  HYPERSYNC_MAX_FILTERS_PER_REQUEST: ["hypersync", "maxFiltersPerRequest"],
  HYPERSYNC_STREAM_CONCURRENCY: ["hypersync", "streamConcurrency"],
  HYPERSYNC_STREAM_BATCH_SIZE: ["hypersync", "streamBatchSize"],
